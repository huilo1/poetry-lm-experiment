...
- the private operational journal: журнал экспериментов, метрики и промежуточные выводы
...
Полная инструкция по разворачиванию: [DEPLOY_AGENT.md](/home/app/projects/Poetry/DEPLOY_AGENT.md)
