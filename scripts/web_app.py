            ...
            <section class="hero">
              <div>
                ...
                <p class="lead">
                  ...
                  весь текст под этот план. На втором этапе отдельно проверялись и большие base-модели с LoRA,
                  чтобы сравнить общий языковой фундамент с узкой scratch-моделью. Ниже можно сравнить, как эти
                  ветки продолжают стих по одной первой строке и какая из них лучше удерживает форму и рифму.
                  Базовая scratch-архитектура:
