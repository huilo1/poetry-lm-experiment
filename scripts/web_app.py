            ...
            <section class="hero">
              <div>
                ...
                <p class="lead">
                  ...
                  весь текст под этот план. На втором этапе были проверены и большие base-модели с LoRA,
                  включая Qwen3-8B-Base и GigaChat3-10B-A1.8B-base, чтобы сравнить общий языковой фундамент
                  с узкой scratch-моделью. Ниже можно сравнить, как эти ветки продолжают стих по одной первой
                  строке и какая из них лучше удерживает форму и рифму. Базовая scratch-архитектура:
